...
from .validators import validate_icon_image_size, validate_image_file_exstansion
...
class Channel(models.Model):
    ...
    banner = models.ImageField(upload_to=server_banner_upload_path, blank=True, null=True, validators=[validate_image_file_exstansion])
    icon = models.ImageField(upload_to=server_icon_upload_path, blank=True, null=True, validators=[validate_icon_image_size, validate_image_file_exstansion])
